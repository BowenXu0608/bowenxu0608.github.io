...
![image](https://hackmd.io/_uploads/ryfSLuo8bg.png)
...
Next, we should add many depandencies we will use into the CMakeLists. Write find_package (Vulkan REQUIRED) and target_link_libraries (VulkanEngine PRIVATE Vulkan::Vulkan) into the CMakeLists, you can include <vulkan/vulkan.h> without any errors after this step. This is the first depandency we need.
 ...
 ![image](https://hackmd.io/_uploads/SyqF__oI-e.png)
...
![image](https://hackmd.io/_uploads/SJzg9_iLZx.png)
...
![image](https://hackmd.io/_uploads/ryoRh_s8Zg.png)

Then add a .editorconfig file into solution too, like this:
![image](https://hackmd.io/_uploads/B15WTdsIZe.png)
...
![image](https://hackmd.io/_uploads/rkFhkKsIbl.png)
...
![image](https://hackmd.io/_uploads/SknVVFjIbe.png)
And recenter the window:
![image](https://hackmd.io/_uploads/SkSc4YjIbg.png)
Put all of them into glfw_monitor.h:
![image](https://hackmd.io/_uploads/S14bvti8Wl.png)
...
![image](https://hackmd.io/_uploads/B1N4uYo8We.png)
...
![image](https://hackmd.io/_uploads/HySXm5s8Zx.png)
...
![image](https://hackmd.io/_uploads/ByAPD9iU-l.png)
...
![image](https://hackmd.io/_uploads/ByYmOcsI-e.png)
...
![image](https://hackmd.io/_uploads/ry-4n5s8bg.png)
...
![image](https://hackmd.io/_uploads/B16UC9jI-l.png)
...
![image](https://hackmd.io/_uploads/rygN-osL-x.png)
...
![image](https://hackmd.io/_uploads/S1tlKsjLWx.png)
...
![image](https://hackmd.io/_uploads/ry3y9joU-g.png)
...
![image](https://hackmd.io/_uploads/Hy-MiisIbl.png)
...
![image](https://hackmd.io/_uploads/HyLqTijIbl.png)
...
![image](https://hackmd.io/_uploads/Hyzelni8We.png)
...
![image](https://hackmd.io/_uploads/SyPVzns8Wg.png)
...
![image](https://hackmd.io/_uploads/BJh14hiIbe.png)
...
![image](https://hackmd.io/_uploads/ry6mE3oIWx.png)
...
![image](https://hackmd.io/_uploads/ByKNkasIZe.png)
...
![image](https://hackmd.io/_uploads/SyyOeajLZx.png)
...
![image](https://hackmd.io/_uploads/BJW8QsnIbx.png)
...
![image](https://hackmd.io/_uploads/ryOMFshIZl.png)
...
![屏幕截图 2026-02-01 123718](https://hackmd.io/_uploads/rJPPjp3U-x.png)
...
![image](https://hackmd.io/_uploads/H184oanL-x.png)
